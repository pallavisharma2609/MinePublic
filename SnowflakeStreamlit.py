...
fig.add_trace(
    go.Bar( x=months, y=numberoftrips,marker=dict(color=[2, 3, 5], coloraxis="coloraxis")),row=1, col=1)
#Second SubPlot
fig.add_trace(
    go.Bar(x=months, y=numberofbikes,marker=dict(color=[4, 5, 6], coloraxis="coloraxis")),row=1, col=2)
