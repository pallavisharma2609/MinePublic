...
fig.update_layout(autosize=False,width=300,height=500,coloraxis=dict(colorscale='Emrld'), showlegend=False,margin=dict(l=20, r=20, t=20, b=20,pad=8))   
st.plotly_chart(fig)
...
fig1.update_layout(autosize=False,width=300,height=500,coloraxis=dict(colorscale='YlGnBu'), showlegend=False,margin=dict(l=20, r=20, t=20, b=20,pad=8))   
...
fig2.update_layout(autosize=False,width=300,height=500,coloraxis=dict(colorscale='dense'), showlegend=False,margin=dict(l=20, r=20, t=20, b=20,pad=8))   
